...
var achievements = __importStar(require("lodestone-css-selectors/profile/achievements.json"));
...
var Achievements = /** @class */ (function (_super) {
    ...
    Achievements.prototype.getCSSSelectors = function () {
        return achievements;
    };
    Achievements.prototype.getBaseURL = function (req) {
        return "https://" + css_selector_registry_1.PAGE_REGION + ".finalfantasyxiv.com/lodestone/character/" + req.params.characterId + "/achievement";
    };
    Achievements.prototype.parse = function (req_1) {
